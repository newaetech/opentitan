...
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, dptr_msg);
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, dptr_r);
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, dptr_s);
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, dptr_x);
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, dptr_y);
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, dptr_d);
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, dptr_rnd); //x_r not used in p384 verify .s
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, dptr_k);

OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, mode);
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, msg);
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, r);
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, s);
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, x);
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, y);
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, d);
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, k);
OTBN_DECLARE_PTR_SYMBOL(p384_ecdsa_sca, rnd); //x_r not used in p384 verify .s file


static const otbn_app_t kOtbnAppP384Ecdsa = OTBN_APP_T_INIT(p384_ecdsa_sca);

static const otbn_ptr_t kOtbnVarDptrMsg = OTBN_PTR_T_INIT(p384_ecdsa_sca, dptr_msg);
static const otbn_ptr_t kOtbnVarDptrR = OTBN_PTR_T_INIT(p384_ecdsa_sca, dptr_r);
static const otbn_ptr_t kOtbnVarDptrS = OTBN_PTR_T_INIT(p384_ecdsa_sca, dptr_s);
static const otbn_ptr_t kOtbnVarDptrX = OTBN_PTR_T_INIT(p384_ecdsa_sca, dptr_x);
static const otbn_ptr_t kOtbnVarDptrY = OTBN_PTR_T_INIT(p384_ecdsa_sca, dptr_y);
static const otbn_ptr_t kOtbnVarDptrD = OTBN_PTR_T_INIT(p384_ecdsa_sca, dptr_d);
static const otbn_ptr_t kOtbnVarDptrRnd = OTBN_PTR_T_INIT(p384_ecdsa_sca, dptr_rnd);
static const otbn_ptr_t kOtbnVarDptrK = OTBN_PTR_T_INIT(p384_ecdsa_sca, dptr_k);

static const otbn_ptr_t kOtbnVarMode = OTBN_PTR_T_INIT(p384_ecdsa_sca, mode);
static const otbn_ptr_t kOtbnVarMsg = OTBN_PTR_T_INIT(p384_ecdsa_sca, msg);
static const otbn_ptr_t kOtbnVarR = OTBN_PTR_T_INIT(p384_ecdsa_sca, r);
static const otbn_ptr_t kOtbnVarS = OTBN_PTR_T_INIT(p384_ecdsa_sca, s);
static const otbn_ptr_t kOtbnVarX = OTBN_PTR_T_INIT(p384_ecdsa_sca, x);
static const otbn_ptr_t kOtbnVarY = OTBN_PTR_T_INIT(p384_ecdsa_sca, y);
static const otbn_ptr_t kOtbnVarD = OTBN_PTR_T_INIT(p384_ecdsa_sca, d);
static const otbn_ptr_t kOtbnVarRnd = OTBN_PTR_T_INIT(p384_ecdsa_sca, rnd);
static const otbn_ptr_t kOtbnVarK = OTBN_PTR_T_INIT(p384_ecdsa_sca, k);
