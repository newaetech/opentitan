...
set_property -dict { PACKAGE_PIN A8  IOSTANDARD LVCMOS33 } [get_ports { IO_GP11 }]; #USERIOB-9
set_property -dict { PACKAGE_PIN B9  IOSTANDARD LVCMOS33 } [get_ports { IO_GP12 }]; #USERIOB-11
set_property -dict { PACKAGE_PIN A9  IOSTANDARD LVCMOS33 } [get_ports { IO_GP13 }]; #USERIOB-15
set_property -dict { PACKAGE_PIN B10 IOSTANDARD LVCMOS33 } [get_ports { IO_GP14 }]; #USERIOB-17
...
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports { IO_UPHY_DPPULLUP }]; #??TODO
set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports { IO_UPHY_SENSE }]; #??TODO
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { IO_UPHY_OE_N }]; #USRUSB_OE
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { IO_UPHY_D_RX }]; #??TODO
