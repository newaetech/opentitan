...
module chip_earlgrey_bergen #(
  // Path to a VMEM file containing the contents of the boot ROM, which will be
  // baked into the FPGA bitstream.
  parameter BootRomInitFile = "boot_rom_fpga_bergen.32.vmem",
  // Path to a VMEM file containing the contents of the emulated OTP, which will be
  // baked into the FPGA bitstream.
  parameter OtpCtrlMemInitFile = "otp_img_fpga_bergen.vmem"
) (
  // Dedicated Pads
  ...
  assign IO_UPHY_SUS = 1'b0;
  assign IO_UPHY_SPD = 1'b1;
...
endmodule : chip_earlgrey_bergen
