...
This is pulled in from the `sw/device/boot_rom` directory (see the `parameters:` section of the `hw/top_earlgrey/chip_earlgrey_bergen-k410t.core` file).
...
The resulting bitstream is located at `build/lowrisc_systems_chip_earlgrey_nexysvideo_0.1/synth-vivado/lowrisc_systems_chip_earlgrey_bergen-k410t_0.1.bit`.
...
$ fusesoc --cores-root . build --no-export --setup lowrisc:systems:chip_earlgrey_bergen-k410t
```
